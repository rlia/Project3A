...
ovs-docker add-port ovs-br4 eth1 open_day_light --ipaddress=172.21.0.2/24
ovs-docker add-port ovs-br4 eth1 rtmp_server --ipaddress=172.21.0.4/24
ovs-docker add-port ovs-br4 eth1 stream_server --ipaddress=172.21.0.5/24
